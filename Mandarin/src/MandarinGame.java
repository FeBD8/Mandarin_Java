...
public class MandarinGame {
    ...
    public void play_round(int n_players,Scanner scanner){
        for (int i = 0; i < n_players; i++){
            players[i].take_turn(dice,board,pagoda,scanner, players);
            if (players[i].getFigures_extracted().size() == 0){
                ...
                do_auction(players[i].getFigures_extracted(),n_players,scanner,i);
    ...
    public void do_auction(ArrayList<Figure> figure_in_palio,int n_players,Scanner scanner, int start_index){
